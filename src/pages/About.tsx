  ...
  >
    ...
    >
      <span className="block">
        At Aalizah Technologies, we are passionate about transforming ideas into innovative digital solutions...
      </span>
      <span className="block">
...
>
  <motion.div
    ...
    className="
      ...
      bg-gradient-to-br from-[#0A0F1F]/80 via-[#0F1A35]/60 to-[#08101E]/80 
      backdrop-blur-2xl 
      shadow-[0_0_50px_rgba(0,150,255,0.15)]
      overflow-hidden
      transition-all duration-300
      hover:shadow-[0_0_60px_rgba(0,180,255,0.25)]
    "
  >
    {/* Floating gradient glow */}
    <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/10 to-cyan-400/10 blur-3xl opacity-40"></div>

    {/* Header */}
    <motion.div variants={fadeUp} className="flex items-center gap-4 mb-12 relative z-10">
      <div className="p-4 bg-gradient-to-r from-blue-500 to-teal-400 rounded-2xl shadow-lg shadow-blue-500/30">
  ...
  {[
    <>At Aalizah Technologies, we turn ideas into powerful digital experiences.</>,
    "We combine creativity, strategic thinking, and world-class technical expertise.",
    <>We focus on <span className="font-semibold text-cyan-300">quality, innovation & customer satisfaction</span> at every step.</>
  ].map((text, i) => (
    <motion.p
      key={i}
      variants={fadeUp}
        ...
        {/* <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="mb-24">
          <motion.div variants={fadeUp} className="text-left mb-12">
            ...
            <p className="text-white text-xl max-w-2xl leading-relaxed text-left">
              Aalizah Technologies has established branches across the globe, bringing innovation to every corner of the world
            </p>
          </motion.div>
