...
import { Camera, Users, Sparkles, BookOpen, Instagram, Facebook, Youtube, Clapperboard } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        variants={fadeUp}
      >
        <h3 className="text-3xl font-bold text-center mb-10">Personal Photography Expertise</h3>
